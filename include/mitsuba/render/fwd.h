...
template <typename BoundingBox3Type> class KDTreeBase;
template <typename BoundingBox3Type, typename TreeConstructionHeuristic, typename Derived> class GenericKDTree;
